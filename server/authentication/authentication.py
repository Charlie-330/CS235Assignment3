...
import server.authentication.services as services
...
@authentication_blueprint.route('/register2', methods=['GET', 'POST'])
def register2():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            return redirect(url_for('authentication_bp.login2'))
    ...
    return render_template(
        ...
        handler_url=url_for('authentication_bp.register2'),
    )




@authentication_blueprint.route('/login2', methods=['GET', 'POST'])
def login2():
    form = LoginForm()
