...
from server.adapters import memory_repository,database_repository
from server.adapters.orm import metadata, map_model_to_tables
...
TEST_DATA_PATH_MEMORY = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'data')
TEST_DATA_PATH_DATABASE = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'data')
TEST_DATABASE_URI_IN_MEMORY = 'sqlite://'
TEST_DATABASE_URI_FILE = 'sqlite:///movies-2020-test.db'
