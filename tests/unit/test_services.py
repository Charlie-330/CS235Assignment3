...
from server.authentication.services import AuthenticationException
from server.movies import services as movies_services
from server.authentication import services as auth_services
from server.movies.services import NonExistentMovieException
...
def test_cannot_add_comment_by_unknown_user(in_memory_repo):
    ...
    with pytest.raises(movies_services.UnknownUserException):
        movies_services.add_comment(comment_text, username, in_memory_repo, movie_rank)
